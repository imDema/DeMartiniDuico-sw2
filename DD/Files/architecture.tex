...
The application server follows the Actor model (See \ref{sect:patterns}) so it can be seen as a set of components which have no shared state, \todo{for clarity ...}
\begin{itemize}
