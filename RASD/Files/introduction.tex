...
\begin{figure}[h]
    ...
    \caption{\label{fig:world_machine} World Machine diagram \todo{\huge Update}}
\end{figure}
...
\begin{description}
    ...
    \item [G7?] \todo{Third parties shall be able to retrieve data about booked visits, including the categories of items requested by each Customer}
...
\todo{
    \begin{description}
        ...
        \item[v. 1.2 - 44/55/666] Adjusted Customer's fields in class diagrams; adjusted target Android API; removed a duplicate line in requirements
    \end{description}
}
