...
\begin{description}
    ...
    \item [G6]  Users shall be able to specify the categories of items they intend to buy \todo{Requirement}
    ...
    \item [G9] Third parties shall be able to retrieve data about booked visits, including the categories of items requested by each User \todo{Requirement}
